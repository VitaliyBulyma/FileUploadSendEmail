            ...
            <div className="row bg-light">
              <div className="col-md-2 col-4 text-center block py-5">
                <div className="round-icon">
                  {" "}
                  <img
                    src="https://i.imgur.com/8lJt6UN.png"
                    width="50px"
                    height="50px"
                    alt=""
                  />{" "}
              ...
              <div className="col-md-2 col-4 text-center block py-5">
                <div className="round-icon">
                  {" "}
                  <img
                    src="https://i.imgur.com/Grjnbah.png"
                    width="50px"
                    height="50px"
                    alt=""
                  />{" "}
              ...
              <div className="col-md-2 col-4 text-center block py-5">
                <div className="round-icon">
                  {" "}
                  <img
                    src="https://i.imgur.com/q2v8mqu.png"
                    width="50px"
                    height="50px"
                    alt=""
                  />{" "}
              ...
              <div className="col-md-2 col-4 text-center block py-5">
                <div className="round-icon">
                  {" "}
                  <img
                    src="https://i.imgur.com/EkmVVM1.png"
                    width="50px"
                    height="50px"
                    alt=""
                  />{" "}
              ...
              <div className="col-md-2 col-4 text-center block py-5">
                <div className="round-icon">
                  {" "}
                  <img
                    src="https://i.imgur.com/ZbZzavI.png"
                    width="50px"
                    height="50px"
                    alt=""
                  />{" "}
              ...
              <div className="col-md-2 col-4 text-center block py-5">
                <div className="round-icon">
                  {" "}
                  <img
                    src="https://i.imgur.com/S6SGKFQ.png"
                    width="50px"
                    height="50px"
                    alt=""
                  />{" "}
            ...
            <div className="review p-5">
              <div className="row d-flex">
                ...
                <div className="ml-md-auto p-2 mx-md-2 pt-4 pt-md-3">
                  {" "}
                  <button className="btn btn-red px-4">
              ...
              <div className="row pb-3">
                <p>
                  This store is incredibly well organized and is at the top of
                  its game.
                </p>
              </div>
            ...
            <div className="review p-5">
              <div className="row d-flex">
                <div className="profile-pic">
                  <img
                    alt=""
                    src="https://www.pngkit.com/png/detail/349-3499697_man-placeholder-blank-avatar-icon-png.png"
                    width="60px"
                    height="60px"
                  />
                </div>
              ...
              <div className="row pb-3">
                <p>
                  This is the second time we've been to this location. The first
                  visit was disappointing as we were looking for information but
                  all we got was a list to choose from. This visit was much
                  better as we got to speak with a very friendly and
                  knowledgeable gentleman who took the time to give us
                  information so we could make a good choice. Will definitely go
                  back.
                </p>
              </div>
              <div className="row ml-1">
          ...
          <div className="m-4">
            <div className="card">
              <div className="card-body text-center">
                <h4 className="card-title">Reviews page</h4>
